...
angular.module('app.main', [])
	...
	// .directive('ngSeries', function(){
 //  		return{
 //    		restrict: 'EAC',
 //    		template: '<accordion-group is-open="status.open">
 //                    <accordion-heading>
 //                        Series 1<i class="pull-right glyphicon" ng-class="{\'glyphicon-chevron-down\': status.open, \'glyphicon-chevron-right\': !status.open}"></i>
 //                    </accordion-heading>
 //                      <a href="#" ng-repeat="number in treeLayer1">
 //                        <img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px">
 //                      </a>
 //                      <!-- <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a><br>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a>
 //                      <a href="#"><img src="img/plus.png" style="width:80px;height:80px;padding-right:15px;padding-bottom:8px"></a> --></br>
